...
def webui_req(U, W, M):
    ...
    if U != 'SwarmUI':
        pull(f'https://github.com/lichunfeng517/segsmaker {U.lower()} {W}')
    else:
    ...
    scripts = [
        f'https://github.com/lichunfeng517/segsmaker/raw/main/script/controlnet.py {W}/asd',
    ...
    if U not in ['SwarmUI', 'ComfyUI']:
        ...
        for ass in [
            ...
            f'https://github.com/lichunfeng517/segsmaker/raw/main/config/NoCrypt_miku.json {W}/tmp/gradio_themes',
            f'https://github.com/lichunfeng517/segsmaker/raw/main/config/user.css {W} user.css'
        ]: download(ass)

        if U != 'Forge': download(f'https://github.com/lichunfeng517/segsmaker/raw/main/config/config.json {W} config.json')
...
def webui_extension(U, W, M):
    ...
    if U == 'ComfyUI':
        ...
        if ENVNAME == 'Kaggle': clone('https://github.com/lichunfeng517/sd-image-encryption')
...
def notebook_scripts():
    z = [
        (STR / '00-startup.py', f'wget -qO {STR}/00-startup.py https://github.com/lichunfeng517/segsmaker/raw/main/script/KC/00-startup.py'),
        (nenen, f'wget -qO {nenen} https://github.com/lichunfeng517/segsmaker/raw/main/script/nenen88.py'),
        (melon, f'wget -qO {melon} https://github.com/lichunfeng517/segsmaker/raw/main/script/melon00.py'),
        (STR / 'cupang.py', f'wget -qO {STR}/cupang.py https://github.com/lichunfeng517/segsmaker/raw/main/script/cupang.py'),
        (MRK, f'wget -qO {MRK} https://github.com/lichunfeng517/segsmaker/raw/main/script/marking.py')
    ]
...
IMG = 'https://github.com/lichunfeng517/segsmaker/raw/main/script/loading.png'
